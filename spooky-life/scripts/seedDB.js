...
mongoose.connect(
  ...
  "mongodb://localhost/hauntedhouselist"
);

const hauntedhouseSeed = [
  {
    name: "13 floor",
    rating: "5",
    location: "Denver, CO",
...
// db.HauntedHouses
//   .remove({})
//   .then(() => db.hauntedhouse.collection.insertMany(hauntedhouseSeed))
//   .then(data => {
...
//     {name: "13 floor",
//     rating: "5",     location: "Denver, CO",     phone:"123-345-6789",     url:"www.google.com"
// },
// {name: "13 floor",
// rating: "5",     location: "Boulder, CO",     phone:"123-345-6789",     url:"www.google.com"
// }
// ])